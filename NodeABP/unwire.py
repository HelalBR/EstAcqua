/*
Biblitoeca para sensores que utilizam o protocolo de comunicação OneWire (1-Wire). Nesse projeto
foram utilizados sensores de temperatura submersa DS18B20 que utiliza o padrão 1-Wire
