/*
Biblioteca do Cayenne Low Power Packer
Cayenne (https://mydevices.com) é o servidor de aplicação utilizado nesse projeto.
A TTN aceita pacotes nesse formato para reduzir a quantidade de bytes enviados por informação.

Maiores informações sobre o Cayenne LPP
